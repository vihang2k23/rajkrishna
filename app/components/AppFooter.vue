      ...
      <div class="footer-content">
        ...
        <div class="footer-section brand">
          ...
          <div class="social-links">
            ...
            <a href="https://www.linkedin.com/in/ashutosh-patel-21560464/" target="_blank" aria-label="LinkedIn">
              <!-- LinkedIn Icon -->
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  <ul class="contact-info">
      ...
      <div class="contact-item">
        ...
        <div class="contact-details space-y-2">
          <p>
            ...
            <a 
              href="https://www.google.com/maps?q=371/47,+Maniyasha+Soc,+Nr.+Madhav+Apartment,+Jasodanagar+Road,+Maninagar+East,+Ahmedabad+380008,+Gujarat,+India" 
              target="_blank" 
    ...
    <li>
      <div class="contact-item">
        ...
        <div class="contact-details">
          <a href="mailto:info.rajkrishnaengineering@gmail.com" class="hover:text-[#EFA72E] transition">
      ...
      <div class="footer-bottom">
        <p>&copy; 2025 Rajkrishna. All rights reserved.</p>
